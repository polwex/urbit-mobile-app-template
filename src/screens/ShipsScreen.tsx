    ...
    <View style={styles.container}>
      <ScrollView style={styles.drawerScroll}>
        ...
        {backgroundShips.map(({ ship }) => <View style={styles.row} key={ship}>
          ...
          <Button title="Remove" color="blue" onPress={() => removeShip(ship)} />
        </View>)}
      </ScrollView>
      <View
      ...
      />
      <Button title="Refresh all ships" color="blue" onPress={handleRefresh} />
      <View style={{ height: 24 }} />
      <Button title="Add ship" color="blue" onPress={handleAdd} />
      <View style={{ height: 24 }} />
      <Button title="Clear all ships" color="blue" onPress={showClearAlert} />
